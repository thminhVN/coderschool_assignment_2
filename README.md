...
**Assignment 2** is a Ruby on Rails blog application that allows users to send messages to each other that can only be read once.
...
![Video Walkthrough](https://github.com/thminhVN/coderschool_assignment_2/blob/master/video_walkthrough.gif)
